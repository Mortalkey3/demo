...
<body>
   ...
   <div id="page-wrapper">
               <div class="row">
                   <div class="col-lg-12">
                       <h1 class="page-header">Data Accounts Admin </h1>
                   </div>
                   <!-- /.col-lg-12 -->
               </div>
               <!-- /.row -->
...
function add_person()
{
    ...
    $.ajax({
        url : "<?php echo base_url('Home/ajax_select')?>",
        type: "POST",
        dataType: "JSON",
...
function save(auth)
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('Home/ajax_add')?>/"+auth;
    } else {
        url = "<?php echo base_url('Home/ajax_update')?>/" + auth;
    }
...
{
			$.ajax({
							url   : '<?php echo base_url('Home/ajax_select_account')?>',
							async : false,
							dataType : 'JSON',
							success : function(data){
									var html = '';
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" id="btnSave" onclick="save(1)" class="btn btn-primary">Save</button>
